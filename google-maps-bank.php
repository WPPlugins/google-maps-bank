...
if (!defined("google_maps_version_number")) {
    define("google_maps_version_number", "2.0.3");
}
...
if ($version >= "2.0.0") {
    ...
    function get_users_capabilities_google_map() {
        ...
        $unserialized_capabilities = unserialize($roles_and_capabilities_data);
        $core_roles = array(
            "manage_options",
            "edit_plugins",
            "edit_posts",
    ...
    if (is_admin()) {
        ...
        function backend_js_css_for_google_map() {
            ...
            $other_settings_unserialize = unserialize($other_settings);
    ...
    /*
      Function Name: google_maps_bank_get_icon_url
      Parameter:yes($url)
      Description:This function is used to get the  choose icons url.
      Created on: 27-04-2017 13:15
      Created By: Tech Banker Team
     */

    function google_maps_bank_get_icon_url($url) {
        $new_url = @file_get_contents($url);
        return $new_url;
    }
