...
if (!is_user_logged_in()) {
    ...
    if (!$access_granted) {
        ...
        $roles_capabilities_data = unserialize($roles_and_capabilities);
        ...
        if (!defined("error_logs_google_map")) {
            define("error_logs_google_map", $full_control[11]);
        }
        ...
        if ($flag == 1) {
            ...
            add_submenu_page("gmb_google_maps", $gm_error_logs, $gm_error_logs, "read", "gmb_error_logs", $check_google_map_wizard == "" ? "gmb_wizard_google_map" : "gmb_error_logs");
        ...
        /*
          Function Name: gmb_error_logs
          Parameters: No
          Description: This function is used to create gm_error_logs menu.
          Created On: 28-01-2017 14:19
          Created By: Tech Banker Team
         */

        function gmb_error_logs() {
            global $wpdb;
            $user_role_permission = get_users_capabilities_google_map();
            if (file_exists(GOOGLE_MAP_DIR_PATH . "includes/translations.php")) {
                include GOOGLE_MAP_DIR_PATH . "includes/translations.php";
            ...
            if (file_exists(GOOGLE_MAP_DIR_PATH . "views/error-logs/error-logs.php")) {
                include_once GOOGLE_MAP_DIR_PATH . "views/error-logs/error-logs.php";
            }
            if (file_exists(GOOGLE_MAP_DIR_PATH . "includes/footer.php")) {
                include_once GOOGLE_MAP_DIR_PATH . "includes/footer.php";
            }
