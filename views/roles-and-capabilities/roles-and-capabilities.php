                                            ...
                                            <table class="table table-striped table-bordered table-hover" id="ux_tbl_author">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="ux_chk_error_logs_author" id="ux_chk_error_logs_author" value="1" <?php echo isset($author) && $author[11] == "1" ? "checked = checked" : "" ?>>
                                                            <?php echo $gm_error_logs; ?>
                                                        </td>
                                                        <td>
                                                        </td>
                                            ...
                                            <table class="table table-striped table-bordered table-hover" id="ux_tbl_editor">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="ux_chk_error_logs_editor" id="ux_chk_error_logs_editor" value="1" <?php echo isset($editor) && $editor[11] == "1" ? "checked = checked" : "" ?>>
                                                            <?php echo $gm_error_logs; ?>
                                                        </td>
                                                        <td>
                                                        </td>
                                            ...
                                            <table class="table table-striped table-bordered table-hover" id="ux_tbl_contributor">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="ux_chk_error_logs_contributor" id="ux_chk_error_logs_contributor" value="1" <?php echo isset($contributor) && $contributor[11] == "1" ? "checked = checked" : "" ?>>
                                                            <?php echo $gm_error_logs; ?>
                                                        </td>
                                                        <td>
                                                        </td>
                                            ...
                                            <table class="table table-striped table-bordered table-hover" id="ux_tbl_subscriber">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="ux_chk_error_logs_subscriber" id="ux_chk_error_logs_subscriber" value="1" <?php echo isset($subscriber) && $subscriber[11] == "1" ? "checked = checked" : "" ?>>
                                                            <?php echo $gm_error_logs; ?>
                                                        </td>
                                                        <td>
                                                        </td>
                                            ...
                                            <table class="table table-striped table-bordered table-hover" id="ux_tbl_other">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="ux_chk_error_logs_other" id="ux_chk_error_logs_other" value="1" <?php echo isset($other) && $other[11] == "1" ? "checked = checked" : "" ?>>
                                                            <?php echo $gm_error_logs; ?>
                                                        </td>
                                                        <td>
                                                        </td>
