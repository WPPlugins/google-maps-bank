                            ...
                            <div class="form-body">
                                <div class="note note-warning">
                                    ...
                                    if ($gm_message_translate_help != "") {
                                        ?>
                                        <h4 class="block"
                                            <strong><?php echo $gm_message_translate_help; ?><br/><?php echo $gm_kindly_click; ?><a href="javascript:void(0);" data-popup-open="ux_open_popup_translator" class="custom_links_feature" onclick="show_pop_up_google_map();"><?php echo $gm_message_translate_here; ?></a></strong>
                                        </h4>
                                        <?php
                                    }
                                    ?>
